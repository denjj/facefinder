...
class App extends Component {
  ...
  onButtonSubmit = () => {
    ...
    fetch('https://fierce-sierra-78934.herokuapp.com/imageurl', {
      method: 'post',
      ...
      .then(response => {
        if (response) {
          fetch('https://fierce-sierra-78934.herokuapp.com/image', {
            method: 'put',
            headers: {'Content-Type': 'application/json'},
            body: JSON.stringify({
  ...
  onRouteChange = (route) => {
    ...
    switch(route) {
      case "home":
        //console.log("route home / signed in")
        this.setState({isSignedIn: true})
        break;
      case "register":
        //console.log("route register / signed out")
        this.setState({isSignedIn: false})
        break;
      default:
        //console.log("route: sign in / signed out")
        this.setState({isSignedIn: false})
